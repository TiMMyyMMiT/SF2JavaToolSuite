...
public class MapAnimationMainEditor extends AbstractMainEditor {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Map index :");

        jSpinner1.setModel(new javax.swing.SpinnerNumberModel(3, 0, 255, 1));
        ...
        directoryButton1.setDirectoryPath(".\\entries\\map03\\");
            directoryButton1.setLabelText("Map path :");

            fileButton4.setFilePath(".\\9-animations.asm");
            fileButton4.setLabelText("Animation file :");
    ...
    private void jButton28ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton28ActionPerformed
        ...
        int mapId = (int)jSpinner1.getValue();
        try {
    ...
    private void jButton29ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton29ActionPerformed
        ...
        Path mapAnimationDataPath = mapDirectory.resolve(fileButton4.getFilePath());
