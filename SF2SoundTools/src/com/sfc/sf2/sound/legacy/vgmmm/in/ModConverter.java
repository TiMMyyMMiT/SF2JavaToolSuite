 ...
 */
package com.sfc.sf2.sound.legacy.vgmmm.in;

import com.sfc.sf2.sound.legacy.vgmmm.out.ChannelContext;
import com.sfc.sf2.sound.legacy.vgmmm.out.ChannelData;
import com.sfc.sf2.sound.legacy.vgmmm.out.Pattern;
import com.sfc.sf2.sound.legacy.vgmmm.out.PcmConverter;
import com.sfc.sf2.sound.legacy.vgmmm.out.PsgConverter;
import com.sfc.sf2.sound.legacy.vgmmm.out.YmConverter;
...
public class ModConverter {
    ...
    private static void exportMod(String filePath){
        ...
        try{
            ...
            com.sfc.sf2.sound.legacy.vgmmm.in.micromod.compiler.Compiler.main(args);
