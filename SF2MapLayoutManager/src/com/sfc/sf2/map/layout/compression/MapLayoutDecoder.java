...
public class MapLayoutDecoder {
    ...
    public MapLayout decode(byte[] layoutData, MapBlockset mapBlockset) {
        this.blockset = mapBlockset.getBlocks();
        this.inputData = layoutData;
    ...
    public byte[] encode(MapLayout layout) {
