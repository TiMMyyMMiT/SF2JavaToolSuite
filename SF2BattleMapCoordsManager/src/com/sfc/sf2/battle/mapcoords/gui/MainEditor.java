...
public class MainEditor extends javax.swing.JFrame {
    ...
    BattleMapCoordsLayout battlemapcoordsLayout = new BattleMapCoordsLayout();
    ...
    private void initComponents() {
        ...
        jPanel16.setBorder(javax.swing.BorderFactory.createTitledBorder("Display"));
        ...
        jCheckBox9.setText("Exploration");
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jTextField21, javax.swing.GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE)
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        ...
        BattleMapCoords[] coords = battlemapcoordsManager.getCoords();
        selectedCoords = 1;
        selectedMapIndex = coords[selectedCoords].getMap();
        
        final String[][] mapEntries = battlemapcoordsManager.getMapEntries();
        
        battlemapcoordsManager.importLayoutDisassembly(coords[selectedCoords], jTextField21.getText(), jTextField22.getText());
    ...
    private void jComboBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox3ActionPerformed
        battlemapcoordsLayout.setCurrentDisplaySize(jComboBox3.getSelectedIndex()+1);
        repaintLayout();
    }//GEN-LAST:event_jComboBox3ActionPerformed

    private void jCheckBox9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox9ActionPerformed
        battlemapcoordsLayout.setDrawExplorationFlags(jCheckBox9.isSelected());
        repaintLayout();
    }//GEN-LAST:event_jCheckBox9ActionPerformed

    private void jCheckBox10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox10ActionPerformed
        battlemapcoordsLayout.setShowGrid(jCheckBox10.isSelected());
        repaintLayout();
    ...
    private void jPanelColorBGMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColorBGMouseClicked
        ...
        if (returnCol != null) {
            ...
            battlemapcoordsLayout.setBGColor(returnCol);
            repaintLayout();
        }
    }//GEN-LAST:event_jPanelColorBGMouseClicked

    private void updateInterface() {
        MapLayout layout = battlemapcoordsManager.getMapLayout();
        if (layout != null) {
            BattleMapCoords[] coords = battlemapcoordsManager.getCoords();
            battlemapcoordsLayout.setMapLayout(layout);
            battlemapcoordsLayout.setBlockset(layout.getBlocks());
            ...
            battlemapcoordsLayout.setBGColor(jPanelColorBG.getBackground());
